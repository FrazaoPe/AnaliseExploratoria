...
menos $100 p \%$ dela é menor ou igual a ele. Observação: $Q_1$, $Q_2$ e $Q_3$ são,
respectivamente os quantis de ordem 0.25, 0.5 e 0.75.
...
![Histograma das idades](figures/Rplot01.png)
...
![Boxplot anos de prisão](figures/Rplot02.png)
...
![Periculosidade X Escolaridade](figures/Rplot03.png)
...
![Periculosidade X Escolaridade](figures/Rplot04.png)
...
periculosidade
![Tempo de Prisão X Score](figures/Rplot05.png)
